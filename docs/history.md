# ocbg history — the full project book (offloaded from README)

> Base `6cb35dc` on `4ad4612`, live build `2.2.0-r7-turn-firing`. Moved verbatim from README.md (lines 232+, 404-line book) during the funnel rewrite — nothing below was edited, only relocated. The operator manual now lives in `README.md`; deep dives live in `docs/internals.md` and `docs/troubleshooting.md`.
